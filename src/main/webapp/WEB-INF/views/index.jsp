...
<div>
    ...
    <p><img src="${userInfo.imageUrl }"></p> <!-- Why doesn't this work? -->
   <p>${userInfo.userName }</p>
   <p>${userInfo.eMail }</p>
   <p>${userInfo.currentPoints } Points Accumulated</p>
   <p>Your Home Location ${userInfo.homeBase }</p>
   <h3>Locations Visited</h3>
   <p>${userInfo.locVisited }</p> <!-- Add a loop around this for mult. locations -->
   <h3>Favorite Cities</h3>
   <p>${userInfo.favCities }</p> <!-- Add a loop around this for mult. locations -->
	 <h3>Favorite Activities</h3>
	<p>${userInfo.favActivities }</p> <!-- Add a loop around this for mult. locations -->
</div>
</body>
</div>
</body>
